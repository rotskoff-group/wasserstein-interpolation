...
create_slurm_script () {
    ...
    WRITE_FILE="./brownian/${1}/${2}/${4}/brownian_test.sbatch"
    ...
    printf "python $(pwd)/test.py --t_h ${2} --t_c 0.1 --var_h 0.1 --var_l 0.01 --time_per_cycle ${1} --dt ${3} --interval_length ${4} --num_intervals ${5}\n" >> $WRITE_FILE
...
# { cd ./brownian/${time_per_cycle}/${t_h}; pwd; sbatch brownian_test.sbatch; } &
...
num_intervals=100
create_slurm_script $time_per_cycle $t_h $dt $interval_length $num_intervals
{ cd ./brownian/${time_per_cycle}/${t_h}/${interval_length}; pwd; sbatch brownian_test.sbatch; } &
