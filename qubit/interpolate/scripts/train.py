...
end_point_densities = torch.load("/scratch/users/shriramc/041122QubitProtocolTraining/tau_500_end_point_densities.pt")
...
d.optimize(interval_length=interval_length,
